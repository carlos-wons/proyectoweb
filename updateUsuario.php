...
/*vacio por cuestion de mucho contenido*/
  ...
  <div class="signupFrm py-5 ">
    <form action="editarUsuario.php" method="POST" onsubmit="return verificarDatos()" class="form" id="frmRegistro" name="frmRegistro">
      <h1>Editar Usuario</h1>

      <div class="inputContainer">
        <input id="correoR" name="correoR" type="text" class="input" placeholder="a" value="<?php echo $row[4] ?>">
        <label for="" class="label">Correo electronico</label>
      </div>

      <div class="inputContainer">
        <input id="userR" name="userR" type="text" class="input" placeholder="a" value="<?php echo $row[1] ?>">
        <label for="" class="label">Nombre de usuario</label>
      </div>

      <div class="inputContainer">
        <input id="passwordR" name="passwordR" type="password" class="input" placeholder="a" value="<?php echo $row[2] ?>">
        <label for="" class="label">Contraseña</label>
      </div>

      <div class="inputContainer">
        <input type="password" id="confirmPassR" name="confirmPassR" class="input" placeholder="a" value="<?php echo $row[2] ?>">
        <label for="" class="label">Confirmar Constraseña</label>
      </div>

      <input type="hidden" id="id" name="id" class="input" placeholder="a" value="<?php echo $row[0] ?>">
      <input type="hidden" id="rolR" name="rolR" class="input" placeholder="a" value="<?php echo $row[3] ?>">

      <input type="submit" class="submitBtn" onclick="validarCorreo();" value="Listo">
    </form>
  </div>
