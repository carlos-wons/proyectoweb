...
<body>
    ...
    <h1 class="container py-4">Mis reservaciones</h1>
    ...
    <tbody>
        <?php
            ...
            $query = "Select * from reservacion where idUsuario=$idUsuario";
            ...
            if($result){
                while($row=$NewConn -> GetRows($result)){
                    echo "<tr>
                        ...
                        <td>".$row[10]."</td>
                        <td>".$row[11]."</td>
                        <td><a href='updateReservacion.php?id=$row[0]'>Actualizar</a></td>
                        <td><a href='cancelarReservacion.php?id=$row[0]'>Cancelar</a></td>
                    </tr>";
                }
